...
public class PokeApiClient {
     ...
     * from the same endOffset to detect delimiters in the stream. Reads the HTTP status-line
     */
    ...
    /**
     * Uses the Two Pointers Algorithm technique - tracking current and previous characters from the same endOffset
